...
import { AuthShaderGradient } from "@/components/ui/shader-gradient";

export default function SplitGradientPage() {
  return (
    <div className="bg-muted flex min-h-screen w-full">
      <div className="grid md:grid-cols-2 w-full h-screen">
        <div className="flex flex-col gap-6 justify-center items-center p-8 md:p-12 lg:p-16">
        ...
        <div className="bg-linear-to-br from-gray-900 to-black relative hidden md:block h-full overflow-hidden">
          <AuthShaderGradient />
        </div>
      </div>
    </div>
